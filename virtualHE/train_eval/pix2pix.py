...
if not DEBUG:
    ...
    a.input_case_list_txt=training_case_txt
    a.mode= "train"
    a.output_dir= Train_output
    a.seed= None
    a.checkpoint=None
    ...
    a.separable_conv= None
    a.aspect_ratio=1.0
    a.lab_colorization= None
    a.batch_size=8
...
def load_examples_from_case_list():
    ...
    tf.convert_to_tensor(input_paths, dtype=tf.string)
...
def main():
    ...
    # tf.config.set_visible_devices(physical_devices[0], device_type=None)
